...
function App() {
  ...
  useEffect(() => {
    ...
    const checkAuthStatus = async () => {
      console.log("Entering checkAuthStatus");
      try {
        ...
        console.log("auth check failed, setting null");
        setAuth(null);
      } finally {
        console.log("entering finally block, setting loading to false");
        setLoading(false);
      }
    };
    checkAuthStatus();
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <Router>
        {loading ? (
          <div className="flex h-screen items-center justify-center">Loading IntelliHire...</div>
        ) : (
          <Routes>
